...
import { BarChart3, Users, Clock3, CalendarRange, Wallet, BriefcaseBusiness, Sparkles, MessageSquareText, ShieldCheck, X, UserSearch } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="mb-8 flex items-center justify-between">
        <div className={cn(collapsed && 'xl:hidden')}>
          ...
          <div className="text-xl font-semibold text-slate-900">
            {user?.role === 'Candidate' ? 'Career Portal' : 'Copilot Suite'}
          </div>
        </div>
      ...
      <div className={cn('mt-auto rounded-2xl border border-blue-100 bg-blue-50 p-4 text-sm text-slate-700', collapsed && 'xl:hidden')}>
        ...
        {user?.role === 'Candidate'
          ? 'Explore job opportunities and submit applications matching your skillset.'
